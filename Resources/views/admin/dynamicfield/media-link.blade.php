...
<div class="form-group">
	...
	<div class="media">
		...
		<div class="clearfix"></div>
			...
			<a class="btn btn-primary btn-browse" onclick="openMediaWindowSingle(event,'');" <?php echo isset($file) ? 'style="display:none;"' : '' ?>><i class="fa fa-upload"></i>
				{{ trans('media::media.Browse') }}
			</a>
		<div class="clearfix"></div>
		<div class="jsThumbnailImageWrapper jsSingleThumbnailWrapper">
    		<figure data-id="{{ $fileId }}">
    			@if ($value > 0)
    				@if(isset($file))
    					<?php $path = $file->path;?>
