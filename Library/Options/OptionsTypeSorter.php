...
use Modules\Dynamicfield\Library\Repeaters\OptionsRepeaterSubFields;
use Modules\Dynamicfield\Library\Repeaters\RepeaterSubFields;

class OptionsTypeSorter implements TypeSorter {
    ...
    public function loopThroughFields($fields)
    {
        ...
        foreach($fields as $key => $field)
        {
            ...
            {
                $fields[$key] = OptionsRepeaterSubFields::collect($field, $this->getFieldTranslationData, $this->options, $key);
            }
        }
